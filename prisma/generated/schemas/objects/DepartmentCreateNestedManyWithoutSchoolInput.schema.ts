...
const Schema: z.ZodType<Prisma.DepartmentCreateNestedManyWithoutSchoolInput> = z
  .object({
    create: z
      .union([
...
export const DepartmentCreateNestedManyWithoutSchoolInputObjectSchema = Schema;
