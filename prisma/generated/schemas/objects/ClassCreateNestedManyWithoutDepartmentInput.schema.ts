...
const Schema: z.ZodType<Prisma.ClassCreateNestedManyWithoutDepartmentInput> = z
  .object({
    create: z
      .union([
...
export const ClassCreateNestedManyWithoutDepartmentInputObjectSchema = Schema;
