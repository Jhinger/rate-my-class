...
const Schema: z.ZodType<Prisma.DepartmentUncheckedUpdateWithoutSchoolInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const DepartmentUncheckedUpdateWithoutSchoolInputObjectSchema = Schema;
