...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithoutClassNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CommentUpsertWithWhereUniqueWithoutClassInputObjectSchema),
        z
          .lazy(() => CommentUpsertWithWhereUniqueWithoutClassInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => CommentUpdateWithWhereUniqueWithoutClassInputObjectSchema),
        z
          .lazy(() => CommentUpdateWithWhereUniqueWithoutClassInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CommentUpdateManyWithoutClassNestedInputObjectSchema = Schema;
