...
const Schema: z.ZodType<Prisma.DepartmentUncheckedUpdateManyWithoutSchoolNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DepartmentUncheckedUpdateManyWithoutSchoolNestedInputObjectSchema =
  Schema;
