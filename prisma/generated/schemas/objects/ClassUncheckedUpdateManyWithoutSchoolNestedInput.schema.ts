...
const Schema: z.ZodType<Prisma.ClassUncheckedUpdateManyWithoutSchoolNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ClassUpsertWithWhereUniqueWithoutSchoolInputObjectSchema,
          ),
          z
            .lazy(
              () => ClassUpsertWithWhereUniqueWithoutSchoolInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ClassUpdateWithWhereUniqueWithoutSchoolInputObjectSchema,
          ),
          z
            .lazy(
              () => ClassUpdateWithWhereUniqueWithoutSchoolInputObjectSchema,
...
export const ClassUncheckedUpdateManyWithoutSchoolNestedInputObjectSchema =
  Schema;
