...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithWhereWithoutClassInput> = z
  .object({
    where: z.lazy(() => CommentScalarWhereInputObjectSchema),
    data: z.union([
      z.lazy(() => CommentUpdateManyMutationInputObjectSchema),
      z.lazy(() => CommentUncheckedUpdateManyWithoutCommentsInputObjectSchema),
    ]),
  })
  .strict();

export const CommentUpdateManyWithWhereWithoutClassInputObjectSchema = Schema;
