...
const Schema: z.ZodType<Prisma.ClassUpdateManyWithoutDepartmentNestedInput> = z
  .object({
    create: z
      .union([
...
export const ClassUpdateManyWithoutDepartmentNestedInputObjectSchema = Schema;
