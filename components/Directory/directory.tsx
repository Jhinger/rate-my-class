...
const Directory = ({ summary }: IDirectoryProps) => {
    ...
    const renderPanels = summary.map((department, index) => 
            <div key={index} className='w-full m-4 p-4 rounded-md bg-primary flex flex-row justify-between items-center ring-2 ring-primary ring-offset-2 ring-offset-secondary hover:ring-tertiary hover:duration-150'>
